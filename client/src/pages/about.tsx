    ...
    <div className="pt-16">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p></p>
          <p>
            <span className="font-semibold text-navy-700">JASWIN AI Solutions</span> is a dynamic technology and consulting startup, blending deep industry expertise with cutting-edge innovation. Founded by BFSI and IT seasoned professionals and fueled by a talented team of technologists and strategists, we deliver agile, impactful solutions for modern enterprises.
          </p>
          <p>
